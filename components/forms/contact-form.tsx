    ...
    return (
      <section className="mx-auto w-full max-w-5xl px-4 pb-16 sm:px-6 sm:pb-24">
        <div className="rounded-2xl border border-primary/40 bg-primary/10 p-6 sm:p-8">
          ...
          <Button type="button" className="mt-5" onClick={() => setIsSuccess(false)}>
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <select id="budgetRange" className={fieldClassName} {...form.register("budgetRange")}>
              ...
              {form.formState.errors.budgetRange ? (
                <p className="text-xs text-red-300">{form.formState.errors.budgetRange.message}</p>
              ) : null}
            </div>
            ...
            <div className="space-y-2">
              ...
              <select id="timeline" className={fieldClassName} {...form.register("timeline")}>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="Tell us about your goals, current challenges, and desired timeline."
